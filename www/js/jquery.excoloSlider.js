        ...
        **********************************************************/
        _onMoveEnd: function () {
            ...
            console.log(base.data.currentSlide);
			 ...
			 if(base.data.currentSlide==0)
			{
				
				if(localStorage.getItem("usernamehng")!=null && localStorage.getItem("usernamehng")!='' && localStorage.getItem("passwordhng")==null && localStorage.getItem("passwordhng")=='')
				{
				 ...
				 if(localStorage.getItem("usernamehng")==null || localStorage.getItem("usernamehng")=='' )
                                   {
